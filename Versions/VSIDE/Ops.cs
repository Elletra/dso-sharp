...
namespace DSO.Versions.VSIDE
{
	public class Ops : Opcodes.Ops
	{
        ...
        public override uint OP_JMPIF => 0x09;
        public override uint OP_JMPIFNOT_NP => 0x0A;
        public override uint OP_JMPIF_NP => 0x0B;
        public override uint OP_JMP => 0x0C;

        public override uint OP_RETURN => 0x0D;

        public override uint OP_CMPEQ => 0x0E;
        public override uint OP_CMPGR => 0x0F;
        public override uint OP_CMPGE => 0x10;
        public override uint OP_CMPLT => 0x11;
        public override uint OP_CMPLE => 0x12;
        public override uint OP_CMPNE => 0x13;

        public override uint OP_XOR => 0x14;
        public override uint OP_MOD => 0x15;
        public override uint OP_BITAND => 0x16;
        public override uint OP_BITOR => 0x17;
        ...
        public override uint OP_SETCUROBJECT_INTERNAL => OP_INVALID;
        ...
        public override uint OP_UNIT_CONVERSION => OP_INVALID;
        ...
        public override uint OP_CREATE_DATABLOCK => 0x54;
        public override uint OP_NAME_OBJECT => 0x55;
        public override uint OP_INEXISTENT_72 => 0x56;
    }
}
