...
namespace DSO.Versions.VSIDE
{
	public class Ops : Opcodes.Ops
	{
        ...
        public override uint OP_ADD_OBJECT => 0x02;
        public override uint OP_END_OBJECT => 0x03;

        public override uint OP_JMPIFFNOT => 0x04;
        public override uint OP_JMPIFNOT => 0x05;
        public override uint OP_JMPIFF => 0x06;
        public override uint OP_JMPIF => 0x07;
        public override uint OP_JMPIFNOT_NP => 0x08;
        public override uint OP_JMPIF_NP => 0x09;
        public override uint OP_JMP => 0x0A;

        public override uint OP_RETURN => 0x0B;

        public override uint OP_CMPEQ => 0x0C;
        public override uint OP_CMPGR => 0x0D;
        public override uint OP_CMPGE => 0x0E;
        public override uint OP_CMPLT => 0x0F;
        public override uint OP_CMPLE => 0x10;
        public override uint OP_CMPNE => 0x11;

        public override uint OP_XOR => 0x12;
        public override uint OP_MOD => 0x13;
        public override uint OP_BITAND => 0x14;
        public override uint OP_BITOR => 0x15;
        public override uint OP_NOT => 0x16;
        public override uint OP_NOTF => 0x17;
        public override uint OP_ONESCOMPLEMENT => 0x18;

        public override uint OP_SHR => 0x19;
        public override uint OP_SHL => 0x1A;
        public override uint OP_AND => 0x1B;
        public override uint OP_OR => 0x1C;

        public override uint OP_ADD => 0x1D;
        public override uint OP_SUB => 0x1E;
        public override uint OP_MUL => 0x1F;
        public override uint OP_DIV => 0x20;
        public override uint OP_NEG => 0x21;
        ...
        public override uint OP_LOADVAR_UINT => 0x26;
        public override uint OP_LOADVAR_FLT => 0x27;
        public override uint OP_LOADVAR_STR => 0x28;

        public override uint OP_SAVEVAR_UINT => 0x29;
        public override uint OP_SAVEVAR_FLT => 0x2A;
        public override uint OP_SAVEVAR_STR => 0x2B;
